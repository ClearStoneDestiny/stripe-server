...
export class AuthController {
  ...
  async refreshSession(@Req() req: Request, @Res() res: Response) {
    ...
    const existingRefreshToken =
      await this.authService.findRefreshToken(refreshToken);
  ...
  async deleteSession(@Req() req: Request, @Res() res: Response) {
    ...
    res.clearCookie(JWT_TOKEN_SETTINGS.ACCESS_TOKEN.name);
    res.clearCookie(JWT_TOKEN_SETTINGS.REFRESH_TOKEN.name);
